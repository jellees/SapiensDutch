...
localizations.values = {
    ...
    flora_birch = "Berkenboom",
    flora_birch_plural = "Berkenbomen",
    ...
    flora_peachTree = "Perzikenboom",
    flora_peachTree_plural = "Perzikenbomen",
    flora_peachTree_summary = "Levert een sappige steenvrucht, rijp in de zomer.",
    flora_peachTree_sapling = "Perzikenboomkiemplant",
    flora_peachTree_sapling_plural = "Perzikenboomkiemplanten",

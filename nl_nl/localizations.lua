...
localizations.values = {
    ...
    tool_weaponBasic_plural = "Simpel wapens",
    ...
    tool_knapping = "Steenbewerkingsgereedschap",
    tool_knapping_plural = "Steenbewerkingsgereedschappen",
    tool_knapping_usage = "Steenbewerken",

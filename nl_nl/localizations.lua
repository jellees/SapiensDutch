...
localizations.values = {
    ...
    resource_hayRotten = "Verrotte Hooi",
    resource_hayRotten_plural = "Verrotte Hooi",
    resource_grass = "Natte Hooi",
    resource_grass_plural = "Natte Hooi",
    resource_flaxDried = "Droge Vlas",
    resource_flaxDried_plural = "Droge Vlas",
    resource_sand = "Zand",
    resource_sand_plural = "Zand",
    resource_rockSmall = "Kleine Steen",
    resource_rockSmall_plural = "Kleine Stenen",
    ...
    resource_stoneHatchet = "Stenen Hakbijl",
    resource_stoneHatchet_plural = "Stenen Hakbijlen",
    ...
    resource_flintHatchet = "Vuurstenen Hakbijl",
    resource_flintHatchet_plural = "Vuurstenen Hakbijlen",
    ...
    resource_logDrum = "Boomstammentrommel",
    resource_logDrum_plural = "Boomstammentrommels",
    ...
    resource_splitLog = "Gespleten Boomstam",
    resource_splitLog_plural = "Gespleten Boomstammen",
    resource_woolskin = "Schapenvacht",
    resource_woolskin_plural = "Schapenvachten",
    resource_bone = "Bot",
    resource_bone_plural = "Botten",
    resource_unfiredUrnWet = "Ongebrande Urn (Nat)",
    resource_unfiredUrnWet_plural = "Ongebrande Urnen (Nat)",
    resource_unfiredUrnDry = "Ongebrande Urn",
    resource_unfiredUrnDry_plural = "Ongebrande Urnen",
    resource_firedUrn = "Gebrande Urn",
    resource_firedUrn_plural = "Gebrande Urnen",
    resource_unfiredUrnHulledWheat = "Gepelde Tarwe (Ongebrande Urn)",
    resource_unfiredUrnHulledWheat_plural = "Gepelde Tarwe (Ongebrande Urn)",
    resource_unfiredUrnHulledWheatRotten = "Beschimmeld Gepelde Tarwe (Ongebrande Urn)",
    resource_unfiredUrnHulledWheatRotten_plural = "Beschimmeld Gepelde Tarwe (Ongebrande Urn)",
    resource_firedUrnHulledWheat = "Gepelde Tarwe (Gebrande Urn)",
    resource_firedUrnHulledWheat_plural = "Gepelde Tarwe (Gebrande Urn)",
    resource_firedUrnHulledWheatRotten = "Beschimmeld Gepelde Tarwe (Gebrande Urn)",
    resource_firedUrnHulledWheatRotten_plural = "Beschimmeld Gepelde Tarwe (Gebrande Urn)",
    resource_quernstone = "Kweern",
    resource_quernstone_plural = "Kweerns",
    resource_unfiredUrnFlour = "Meel (Ongebrande Urn)",
    resource_unfiredUrnFlour_plural = "Meel (Ongebrande Urn)",
    resource_unfiredUrnFlourRotten = "Beschimmeld Meel (Ongebrande Urn)",
    resource_unfiredUrnFlourRotten_plural = "Beschimmeld Meel (Ongebrande Urn)",
    resource_firedUrnFlour = "Meel (Gebrande Urn)",
    resource_firedUrnFlour_plural = "Meel (Gebrande Urn)",
    resource_firedUrnFlourRotten = "Beschimmeld Meel (Gebrande Urn)",
    resource_firedUrnFlourRotten_plural = "Beschimmeld Meel (Gebrande Urn)",
    ...
    resource_mudBrickWet = "Modderbaksteen (Nat)",
    resource_mudBrickWet_plural = "Modderbakstenen (Nat)",
    resource_mudBrickDry = "Modderbaksteen (Droog)",
    resource_mudBrickDry_plural = "Modderbakstenen (Droog)",
    ...
    --storage
    storage_rockSmall = "Kleine Stenen",
    storage_seed = "Zaden",
    storage_rock = "Grote Stenen",
    ...
    storage_logDrum = "Boomstammentrommel",

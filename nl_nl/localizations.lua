...
localizations.values = {
    ...
    -- buildables
    buildable_craftArea = "Ambachtsgebied",
    buildable_craftArea_plural = "Ambachtsgebieden",
    buildable_craftArea_summary = "Maak normale dingen, simpele gereedschappen.",
    buildable_storageArea = "Opslagplek",
    buildable_storageArea_plural = "Opslagplekken",
    ...
    buildable_campfire_summary = "Het kampvuur geeft warmte en ligt en is een plek om eten te koken zodat het een grotere voedingswaarde krijgt.",
    buildable_brickKiln = "Oven",
    buildable_brickKiln_plural = "Ovens",
    buildable_brickKiln_summary = "Ovens kunnen worden gebruikt om aardwerkt te bakken. Gebakken aardenwerk is meer water resistant en gaat langer mee dan ongebakken aardewerk.",
    ...
    buildable_thatchRoofLargeCorner_summary = "A large roof section.",
